...
const FormLogin = () => {
  return (
    <>
      <div className=" flex justify-center items-center flex-[0_1_98.375rem] max-[768px]:min-h-[45rem] max-[768px]:p-[1.5rem] max-sm:p-[.5rem] p-2 bg-[#bfdfff] min-h-[54rem] rounded-lg shadow-xl ">
        <div className="  flex flex-col justify-between flex-[0_1_39.25rem]  max-[768px]:min-h-[39.625rem] max-sm:p-4  bg-white min-h-[52.625rem] rounded-lg ">
        ...
        <div className="animate-fade animate-once animate-delay  flex-[0_1_22.6875rem]  min-h-[52.625rem] overflow-hidden rounded-md  max-[768px]:hidden flex justify-center items-center relative   ">
