    ...
    <>
      ...
      <div className="flex" >
        <div className="flex gap-2 " >
          <p className="text-lg underline text-white" >{name}</p>
          <Avatar size="lg" onClick={openEditProfile} className="cursor-pointer h-[2rem] w-[2rem] text-b text-white bg-black" src="" alt="profile" />
        </div>
      </div>
    </>
  )
