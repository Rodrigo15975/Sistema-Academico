  ...
  return (
    <>
      <div className="flex justify-center items-center flex-[0_1_98.375rem] max-[768px]:min-h-[45rem] max-[768px]:p-[1.5rem] outline-double outline-black/10 max-sm:p-[.5rem] p-2 bg-login min-h-[54rem] rounded-lg shadow-sm ">
        <div className="flex flex-col justify-between flex-[0_1_39.25rem] border max-[768px]:min-h-[39.625rem] max-sm:p-4 bg-white min-h-[45.625rem] rounded-lg ">
        ...
        <div className="animate-fade animate-once animate-delay flex-[0_1_22.6875rem] border min-h-[45.625rem] overflow-hidden rounded-md max-[768px]:hidden flex justify-center items-center relative">
