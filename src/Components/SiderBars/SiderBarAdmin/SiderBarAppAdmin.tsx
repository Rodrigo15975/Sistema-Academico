...
const SiderBarAppAdmin = () => {
  ...
  return (
    <>
      <div className=" flex flex-col justify-between  gap-3 py-4 flex-[0_0_18.125rem] min-h-[100vh] bg-[#0a0505] " >
        ...
        <div className="flex-[0_1_3rem] mt-4 p-2  " >
          <m.button initial  onClick={logoutProfesor} className="bg-white/10 flex items-center text-white transition hover:bg-blue-600  justify-center  w-full min-h-[2.5rem] text-1xl rounded-3xl ">
